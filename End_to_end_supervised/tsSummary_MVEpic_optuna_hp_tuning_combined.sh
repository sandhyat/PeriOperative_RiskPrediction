...
do
  echo $number
  echo $1
  python /codes/End_to_end_supervised/MV_Epic_TSSummary_optuna_hp_tuning.py --meds --task=$1  --randomSeed=$number
  python /codes/End_to_end_supervised/MV_Epic_TSSummary_optuna_hp_tuning.py --flow --task=$1  --randomSeed=$number
  python /codes/End_to_end_supervised/MV_Epic_TSSummary_optuna_hp_tuning.py --meds --flow --task=$1  --randomSeed=$number
  python /codes/End_to_end_supervised/MV_Epic_TSSummary_optuna_hp_tuning.py --meds --flow --preops --task=$1  --randomSeed=$number
  python /codes/End_to_end_supervised/MV_Epic_TSSummary_optuna_hp_tuning.py --meds --flow --preops --homemeds --task=$1  --randomSeed=$number
  python /codes/End_to_end_supervised/MV_Epic_TSSummary_optuna_hp_tuning.py --meds --flow --preops --homemeds --pmhProblist --task=$1  --randomSeed=$number
done