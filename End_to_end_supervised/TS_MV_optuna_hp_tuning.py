...
def objective(trial, args):
    ...
    if 'meds' in modality_to_use:
        ...
        if args.drugNamesNo == True:
            ...
            drug_med_id_map = pd.read_csv(
                data_dir + 'mv_data/med_ts/mv_drug_names.csv')  ## since there are more medications in the MV era, I am using the the med mapping from mv era
            drug_words = None
            word_id_map = None
        else:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='TS (MV+Epic) modular different model training')
